...
while OPT != 1 and OPT != 2 :
    print("Please input your option to choose cv2.PCACompute result or my own PCA function(1 or 2):")
    OPT = int(input("1:OpenCV\n2:Own\n"))
    ...
    if OPT == 2 :
        Mean = np.load('save_database\\save_Mean_my.npy')
        A = np.load('save_database\\save_A_my.npy')
        eigenfaces = np.load('save_database\\eigenface_my.npy')
